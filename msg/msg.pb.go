...
import (
	...
	conversation "github.com/lincome/protocol/conversation"
	sdkws "github.com/lincome/protocol/sdkws"
...
type ModifyMsgReq struct {
	...
	Content        []byte                 `protobuf:"bytes,5,opt,name=content,proto3" json:"content"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *ModifyMsgReq) GetContentType() int32 {
	if x != nil {
		return x.ContentType
	}
	return 0
...
func (x *ModifyMsgReq) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
const file_msg_msg_proto_rawDesc = "" +
	...
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.openim.sdkws.MsgDataR\x05value:\x028\x01\"\x9c\x01\n" +
	"\fModifyMsgReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\x12\x10\n" +
	"\x03seq\x18\x03 \x01(\x03R\x03seq\x12 \n" +
	"\vcontentType\x18\x04 \x01(\x05R\vcontentType\x12\x18\n" +
	"\acontent\x18\x05 \x01(\fR\acontent\"\x0f\n" +
	"\rModifyMsgResp2\xca\x17\n" +
	"\x03msg\x12@\n" +
	"\tModifyMsg\x12\x18.openim.msg.ModifyMsgReq\x1a\x19.openim.msg.ModifyMsgResp\x12D\n" +
	...
	"\x0eGetLastMessage\x12\x1d.openim.msg.GetLastMessageReq\x1a\x1e.openim.msg.GetLastMessageRespB!Z\x1fgithub.com/lincome/protocol/msgb\x06proto3"
...
var file_msg_msg_proto_goTypes = []any{
	...
	(*ModifyMsgReq)(nil),                         // 81: openim.msg.ModifyMsgReq
	(*ModifyMsgResp)(nil),                        // 82: openim.msg.ModifyMsgResp
...
var file_msg_msg_proto_depIdxs = []int32{
	...
	81,  // 41: openim.msg.msg.ModifyMsg:input_type -> openim.msg.ModifyMsgReq
	...
	82,  // 75: openim.msg.msg.ModifyMsg:output_type -> openim.msg.ModifyMsgResp
